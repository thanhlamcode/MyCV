...
function Resume({ resume }) {
  ...
  return (
    <section className="resume" id="resume">
      <h2 className="text-center">1.5+ Years of Experience</h2>
      <h1 className="text-center">My Resume</h1>
      <div className="bar">
        <Row gutter={20}>
          <Col xl={12} md={12} xs={24}>
            <div className="box" data-education onClick={() => handleClick("education")}>
              Education
            </div>
          </Col>
          <Col xl={12} md={12} xs={24}>
            <div className="box" data-certificate onClick={() => handleClick("certificate")}>
              Certificate
            </div>
          </Col>
        </Row>
