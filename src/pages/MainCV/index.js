  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          property="og:url"
          content={`https://doanthanhlam.vercel.app/${slug || ""}`}
        />
        <meta
          property="og:image"
        ...
        <link
          rel="canonical"
          href={`https://doanthanhlam.vercel.app/${slug || ""}`}
        />
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            url: `https://doanthanhlam.vercel.app/${slug || ""}`,
            image:
              data.information?.profilePicture || "/logo192.png",
            description:
              data.information?.description ||
